...
export type PaymentStatus = 'pending' | 'collected' | 'settled' | 'disputed' | 'refunded' | 'failed' | 'cancelled' | 'returned';
...
const paymentSchema = new Schema<IPayment>({
  ...
  status: {
    type: String,
    enum: ['pending', 'collected', 'settled', 'disputed', 'refunded', 'failed','cancelled', 'returned'],
    default: 'pending',
    index: true,
  },
